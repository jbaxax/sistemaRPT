...
<tr>
    ...
    <img src="../public/images/logo.jpg" width="80px" alt=""> <br><br>
        <b>SISTEMA DE VENTAS RPT</b> <br>
    Jr Jose Galvez 260 P.J. San Gabirel Alto #260 <br>
    23884774 - 75657007 <br>
    LIMA - PERÚ
    </td>
    <td style="width: 150px"></td>
    <td style="font-size: 16px;width: 290px"><br><br><br>
        <b>DNI: </b>10740291268 <br>
        <b>Nro factura:</b> '.$id_venta_get.' <br>
        <b>Nro de autorización: </b>10740291268
...
$QR = 'Factura realizada por el sistema de ventas RPT, al cliente '.$nombre_cliente.' con Documento de Identidad: '.$dni_cliente.' 
