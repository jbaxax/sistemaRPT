                            ...
                            <table id="example1" class="table table-bordered table-striped table-sm">
                                ...
                                foreach ($proveedores_datos as $proveedores_dato){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $proveedores_dato['RUC'];?></td>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="number" id="RUC<?php echo $id_proveedor;?>" value="<?php echo $proveedores_dato['RUC'];?>" class="form-control">
                                                    ...
                                                    <script>
                                                        $('#btn_update<?php echo $id_proveedor;?>').click(function () {
                                                            ...
                                                            if(nombre_proveedor == ""){
                                                                ...
                                                                $('#RUC<?php echo $id_proveedor;?>').focus();
                                                                ...
                                                                $.get(url,{id_proveedor:id_proveedor,nombre_proveedor:nombre_proveedor,celular:celular,ruc:ruc,empresa:empresa,email:email,direccion:direccion},function (datos) {
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="">RUC <b>*</b></label>
                                                                            <input type="number" id="RUC<?php echo $id_proveedor;?>" value="<?php echo $proveedores_dato['RUC'];?>" class="form-control" disabled>
                                                                            <small style="color: red;display: none" id="lbl_empresa<?php echo $id_proveedor;?>">* Este campo es requerido</small>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
...
<script>
    $('#btn_create').click(function () {
        ...
        if(nombre_proveedor == ""){
            ...
            $.get(url,{nombre_proveedor:nombre_proveedor,celular:celular,RUC:RUC,empresa:empresa,email:email,direccion:direccion},function (datos) {
                $('#respuesta').html(datos);
            });
        }
